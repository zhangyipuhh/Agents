...
# ----------------------------------------------------------------------
# get_server_detail 详情接口（2026-07-22 新增）
# ----------------------------------------------------------------------


def test_get_server_detail_returns_whitelist_and_inspection_script():
    """详情接口：命中时返回白名单与脚本字段，且不外泄 ip/password/blacklist。"""
    from app.shared.utils.devops_server_service import DevOpsServerService
    ...
    assert detail["inspection_script"] == "echo hi"
