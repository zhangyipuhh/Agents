...
def get_report_config(data: dict) -> ReportConfig:
    ...
    toc = TocConfig(
        ...
        entries=[
            ...
            TocEntry(text="2. 供地方式", level=2),
            TocEntry(text="3. 土地利用状况", level=2),
            TocEntry(text="4. 矿产压覆", level=2),
            TocEntry(text="5. 占用耕地和永久基本农田", level=2),
            TocEntry(text="6. 涉及生态保护红线情况", level=2),
            TocEntry(text="7. 地质灾害危险性评估", level=2),
            TocEntry(text="（二） 要素保障分析", level=1),
            TocEntry(text="1. 相关的国土空间规划", level=2),
            TocEntry(text="2. 土地利用年度计划", level=2),
            TocEntry(text="3. 建设用地控制指标", level=2),
            TocEntry(text="4. 节地水平", level=2),
            TocEntry(text="5. 农用地转用和土地征收手续办理安排", level=2),
            TocEntry(text="6. 耕地占补平衡可行性", level=2),
            TocEntry(text="7. 永久基本农田占用补划可行性", level=2),
            TocEntry(text="二、 与主体功能区的协同性（可研编制大纲外事项）", level=0),
            TocEntry(text="三、 其他空间管控分析（可研编制大纲外事项）",  level=0),
            TocEntry(text="（一） 涉及自然保护地情况", level=1),
            TocEntry(text="（二） 历史文化保护情况", level=1),
            TocEntry(text="四、 其他国土空间用途管制要求（可研编制大纲外事项）",  level=0),
            TocEntry(text="（一） 违法用地情况", level=1),
            TocEntry(text="（二） 林草地占用情况", level=1),
        ],
        entry_font_name="宋体",
        entry_font_size=12,
